...
ii = 0
for class_dir in load_paths(images_dir):  #TODO: Make progress bar precision one level lower
    print(f"Converting to JPEG: {round(float(ii) / float(total_gen) * 100, 2)} %", end='\r')
